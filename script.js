...
let consolePrice = +prompt('Стоимость приставки', 40000);
let ridePrice = +prompt('Стоимость транспорта', 50);
let mamyMoney = +prompt('Сумма денег от мамы на проезд', 300);
let lunchMoney = +prompt('Сумма денег от мамы на обед', 450);
